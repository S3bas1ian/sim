...
G4VPhysicalVolume *MyDetectorConstruction::Construct()
{
    ...
    G4Material *H20 = new G4Material("H20", 0.997*g/cm3, 2);
    ...
    G4double energy[2] = {1.239841939*eV/0.9 , 1.239841939*eV/0.2}; //energy by 200nm (blue) and red light (900nm)
    ...
    logicDetector = new G4LogicalVolume(solidDetector, worldMat, "logicDetectr");
